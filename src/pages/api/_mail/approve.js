...
<head>
  ...
  <title>Booking Approval - ${footerInfos.entreprise}</title>
</head>
  ...
  <table cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color: #f3f4f6; padding: 40px 20px;">
    <tr>
        ...
        <table cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width: 650px; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.07);">
          <tr>
            <td style="background: linear-gradient(135deg, #22c55e 0%, #16a34a 100%); padding: 40px 30px; text-align: center;">
              ...
              <h1 style="margin: 0 0 12px 0; color: #ffffff; font-size: 32px; font-weight: 700; letter-spacing: -0.5px;">Booking Approved</h1>
              <p style="margin: 0; color: #dcfce7; font-size: 16px; font-weight: 400;">Your booking has been confirmed</p>
            </td>
          </tr>
          <tr>
            <td style="padding: 30px 30px 20px 30px;">
              ...
              <p style="margin: 0; color: #4b5563; font-size: 15px; line-height: 1.6;">
                Your booking for <strong>${tour}</strong> (Ref: ${bookingRef}) has been approved! Below are the details of your trip.
              </p>
            </td>
          </tr>
          <tr>
              ...
              <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                  <td style="padding-bottom: 20px;">
                    <h2 style="margin: 0; color: #1f2937; font-size: 22px; font-weight: 700; border-bottom: 3px solid #22c55e; padding-bottom: 12px; display: inline-block;">
                      📋 Tour Details
                    </h2>
                  </td>
                </tr>
              </table>
              <table cellpadding="0" cellspacing="0" border="0" width="100%" style="background: linear-gradient(135deg, #ecfdf5 0%, #d1fae5 100%); border-radius: 12px; overflow: hidden; border: 2px solid #a7f3d0;">
                <tr>
                  <td style="padding: 24px;">
                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                      <tr>
          ...
          <tr>
            <td style="background-color: #1f2937; padding: 30px; text-align: center;">
              ...
              <p style="margin: 0 0 16px 0;">
                <a href="mailto:${footerInfos.email}" style="color: #22c55e; text-decoration: none; font-weight: 500;">${footerInfos.email}</a>
              </p>
      ...
      await transporter.sendMail({
        ...
        to: email,
        subject: `✓ Booking Approval - ${footerInfos.entreprise}`,
        text: `Your booking for the tour "${tour}" has been approved.`,
        html: htmlContent,
      });

      return res.status(200).json({ message: 'Approval email sent!' });
    } catch (error) {
      console.error('Error sending approval email:', error);
      return res.status(500).json({ message: 'Failed to send approval email', details: error.message });
    }
  } else {
